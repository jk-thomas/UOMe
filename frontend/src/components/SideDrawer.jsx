    ...
    <>
      ...
      <aside className="drawer" role="dialog" aria-modal="true">
        ...
        <nav className="drawer-nav">
          ...
          <NavButton view="owed_opt" label="Net Payments To You: " badge={paymentsToMe.length} />
          <NavButton view="owe_opt" label="Net Payments You Make: " badge={paymentsIMake.length} />
        </nav>
